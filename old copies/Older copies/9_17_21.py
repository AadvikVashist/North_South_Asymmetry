...
def shift (csv, image, lat, lon, crop):
    ...
    nsa_lats = []; nsa_lons = []
    cols = []
    for col in range(133): # 133 = image width
...
def main(DirectoryFolder, imgDirectoryFolder):    
    ...
    for filename in os.listdir(imgDirectoryFolder):
        ...
        if (filename.endswith(imgFileTypes)): 
            ...
            i+=1
            fileInfo[2] = i
bigFolder = 'C:/Users/aadvi/Desktop/Titan Paper/Data/T62/'
imageFolder = 'C:/Users/aadvi/Desktop/Titan Paper/Data/T62/T62.vis.cyl/'
